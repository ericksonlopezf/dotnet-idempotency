...
/// <para>
/// Note: Value equality (<c>==</c>, <c>Equals</c>) uses case-sensitive ordinal comparison
/// (auto-generated by the compiler for <c>record struct</c> types).
/// Only ordering comparisons (<c>CompareTo</c>, <c>&lt;</c>, <c>&gt;</c>) apply case-insensitive ordinal rules.
/// </para>
/// </remarks>
