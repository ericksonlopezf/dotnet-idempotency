...
{
    /// <summary>
    /// Registers the MariaDB implementation of <see cref="IIdempotencyStore"/> and <see cref="ITransactionalIdempotencyStore"/>
    /// in the specified service collection.
    /// </summary>
    ...
    public static IServiceCollection AddMariaDbIdempotencyStore(this IServiceCollection services)
    {
        ...
        services.TryAddSingleton<ITransactionalIdempotencyStore>(sp => sp.GetRequiredService<MariaDbIdempotencyStore>());
        return services;
    }
}
