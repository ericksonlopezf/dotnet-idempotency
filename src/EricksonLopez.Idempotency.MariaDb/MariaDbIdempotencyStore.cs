...
/// <summary>
/// Provides a MariaDB persistence store implementation for <see cref="IIdempotencyStore"/> and
/// <see cref="ITransactionalIdempotencyStore"/> using <see cref="MySqlDataSource"/>.
/// </summary>
public sealed class MariaDbIdempotencyStore : ITransactionalIdempotencyStore
{
