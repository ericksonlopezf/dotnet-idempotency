...
/// <summary>
/// Provides a MariaDB persistence store implementation for <see cref="IIdempotencyStore"/> using Dapper and <see cref="MySqlDataSource"/>.
/// </summary>
public sealed class MariaDbIdempotencyStore : IIdempotencyStore
{
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="MariaDbIdempotencyStore"/> class with the specified MySQL or MariaDB data source.
    /// </summary>
    /// <param name="dataSource">The configured MySQL/MariaDB data source.</param>
    /// <exception cref="ArgumentNullException"><paramref name="dataSource"/> is <see langword="null"/></exception>
    public MariaDbIdempotencyStore(MySqlDataSource dataSource)
    {
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        var existing = await connection.QuerySingleOrDefaultAsync<MariaDbRecordDto>(
    ...
    internal sealed class MariaDbRecordDto
    {
