...
{
    /// <summary>
    /// Registers the MySQL implementation of <see cref="IIdempotencyStore"/> and <see cref="ITransactionalIdempotencyStore"/>
    ...
    public static IServiceCollection AddMySqlIdempotencyStore(this IServiceCollection services)
    {
        ...
        services.TryAddSingleton<ITransactionalIdempotencyStore>(sp => sp.GetRequiredService<MySqlIdempotencyStore>());
        return services;
    }
}
