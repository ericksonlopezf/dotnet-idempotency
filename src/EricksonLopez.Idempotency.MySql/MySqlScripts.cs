...
/// <summary>
/// Provides raw SQL script definitions for MySQL schema generation and indexes.
/// </summary>
public static class MySqlScripts
{
    /// <summary>
    /// Gets the DDL script for creating the idempotency records table and associated indexes in MySQL.
    /// </summary>
